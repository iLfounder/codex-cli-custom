...
| 순서형 0.149 patch export와 clean-apply 검증 | 완료; 11개 patch가 tree `e76aa7e4e7b0ec0902d525e939baf9d34ffdccf1`를 재현함 |
...
Applier는 dirty 또는 잘못된 base worktree를 거절하고, 각 patch digest를 검증하며, P001–P011을 순서대로 적용한 뒤 final tree `e76aa7e4e7b0ec0902d525e939baf9d34ffdccf1`를 요구한다.
